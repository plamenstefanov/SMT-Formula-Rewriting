...
(assert (and (>= (+ (* a__6 a__7 a__5 a__2) (* a__8 a__3) (- 0 1)) 0) (>= (+ (* a__7 a__7 a__5 a__2) (* (- 0 1) (* a__7 a__5 a__2))) 0) (>= (+ (* a__10 a__3) (* (- 0 1) a__3)) 0) (>= a__6 0) (>= a__7 0) (>= a__5 0) (>= a__2 0) (>= a__8 0) (>= a__3 0) (>= a__10 0)))
(check-sat)
;;(get-assignment)
;;(get-model)
(exit)
