...
(assert (and (>= (+ (* a__4 a__7 a__3) (* (- 0 1) (* a__5 a__6 a__3)) (* (- 0 1) (* a__4 a__6 a__6 a__3)) (* (- 0 1) (* a__4 a__7 a__6 a__3)) (- 0 1)) 0) (>= (+ (* a__6 a__3) (* (- 0 1) (* a__7 a__3))) 0) (>= a__4 0) (>= a__7 0) (>= a__3 0) (>= a__5 0) (>= a__6 0)))
(check-sat)
;;(get-assignment)
;;(get-model)
(exit)
