...
(assert (and (>= (+ 1 (* (- 0 1) b__9)) 0) (= (+ (* b__9 a__2) (* (- 0 1) a__2)) 0) (>= (+ (* b__9 a__8 a__6) (* (- 0 1) (* b__9 a__6))) 0) (>= (+ (* a__4 a__2) (* (- 0 1) (* a__5 a__2)) (- 0 1)) 0) (= (* a__6 a__2) 0) (>= b__9 0) (>= 1 b__9) (>= a__2 0) (>= a__8 0) (>= a__6 0) (>= a__4 0) (>= a__5 0)))
(check-sat)
;;(get-assignment)
;;(get-model)
(exit)
