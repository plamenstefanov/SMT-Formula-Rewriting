...
(assert (and (>= (+ (* a__4 a__3) (* a__4 a__5 a__3) (* a__4 a__5 a__5 a__3) (* a__8 a__5 a__5 a__5 a__3) (- 0 1)) 0) (>= (+ (* a__6 a__3) (* (- 0 1) a__3)) 0) (>= (+ (* a__6 a__5 a__5 a__3) (* (- 0 1) a__3)) 0) (>= a__4 0) (>= a__3 0) (>= a__5 0) (>= a__8 0) (>= a__6 0)))
(check-sat)
;;(get-assignment)
;;(get-model)
(exit)
