...
(assert (and (>= (+ (* a__5 a__2) (* (- 0 1) a__7)) 0) (>= (+ a__3 (* (- 0 1) a__8)) 0) (>= (+ a__7 (* (- 0 1) a__2)) 0) (>= (+ a__8 (* (- 0 1) a__3)) 0) (>= (+ a__1 (* a__4 a__2) (* (- 0 1) a__6)) 0) (>= (+ a__6 (* (- 0 1) a__1)) 0) (not (and (= (+ a__1 (* a__4 a__2) (* (- 0 1) a__6)) 0) (= (+ a__6 (* (- 0 1) a__1)) 0))) (>= a__5 0) (>= a__2 0) (>= a__7 0) (>= a__3 0) (>= a__8 0) (>= a__1 0) (>= a__4 0) (>= a__6 0)))
(check-sat)
;;(get-assignment)
;;(get-model)
(exit)
