...
(assert (and (>= (+ (* a__4 a__2) (* (- 0 1) a__2)) 0) (>= (+ (* a__8 a__2) (* (- 0 1) a__2)) 0) (>= (+ (* a__9 a__2) (* (- 0 1) a__2)) 0) (>= (* a__3 a__2) 0) (>= (* a__7 a__2) 0) (not (and (= (* a__3 a__2) 0) (= (* a__7 a__2) 0))) (>= a__4 0) (>= a__2 0) (>= a__8 0) (>= a__9 0) (>= a__3 0) (>= a__7 0)))
(check-sat)
;;(get-assignment)
;;(get-model)
(exit)
