...
(assert (and (>= (+ 1 (* (- 0 1) b__10)) 0) (= (+ (* b__10 a__4) (* (- 0 1) a__4)) 0) (>= (+ (* b__10 a__6) (* b__10 a__8 a__7) (* (- 0 1) (* b__10 a__9))) 0) (>= (+ (* a__7 a__5) (* (- 0 1) a__5)) 0) (>= (+ a__5 (- 0 1)) 0) (>= (+ a__6 (- 0 1)) 0) (>= b__10 0) (>= 1 b__10) (>= a__4 0) (>= a__6 0) (>= a__8 0) (>= a__7 0) (>= a__9 0) (>= a__5 0)))
(check-sat)
;;(get-assignment)
;;(get-model)
(exit)
