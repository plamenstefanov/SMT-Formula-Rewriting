...
(assert (and (>= (+ 1 (* (- 0 1) b__7)) 0) (= (+ (* b__7 a__4) (* (- 0 1) a__4)) 0) (>= (+ (* b__7 a__6 a__6) (* (- 0 1) (* b__7 a__6))) 0) (>= (+ (* a__5 a__2) (* (- 0 1) (* a__5 a__4)) (- 0 1)) 0) (>= (+ a__4 (* (- 0 1) a__2) (* (- 0 1) a__3) (* (- 0 1) (* a__6 a__4))) 0) (>= b__7 0) (>= 1 b__7) (>= a__4 0) (>= a__6 0) (>= a__5 0) (>= a__2 0) (>= a__3 0)))
(check-sat)
;;(get-assignment)
;;(get-model)
(exit)
